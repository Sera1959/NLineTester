public class DESAlgorithm
{
  ...
  private void des_encrypt(int[] ai, int[] ai1, boolean flag)
  {
    ...
    if (flag) {
      for (int j1 = 0; j1 < 32; j1 += 8)
      {
        ...
        int k = j ^ ai1[(j1 + 1)];
        k = _lrotr(k);
        i ^= (des_SPtrans[1][(k & 0x3F)] | des_SPtrans[3][(k >>> 8 & 0x3F)] | des_SPtrans[5][(k >>> 16 & 0x3F)] | des_SPtrans[7][(k >>> 24 & 0x3F)] | des_SPtrans[0][(i1 & 0x3F)] | des_SPtrans[2][(i1 >>> 8 & 0x3F)] | des_SPtrans[4][(i1 >>> 16 & 0x3F)] | des_SPtrans[6][(i1 >>> 24 & 0x3F)]);
        i1 = i ^ ai1[(j1 + 2)];
        k = i ^ ai1[(j1 + 2 + 1)];
        k = _lrotr(k);
        j ^= (des_SPtrans[1][(k & 0x3F)] | des_SPtrans[3][(k >>> 8 & 0x3F)] | des_SPtrans[5][(k >>> 16 & 0x3F)] | des_SPtrans[7][(k >>> 24 & 0x3F)] | des_SPtrans[0][(i1 & 0x3F)] | des_SPtrans[2][(i1 >>> 8 & 0x3F)] | des_SPtrans[4][(i1 >>> 16 & 0x3F)] | des_SPtrans[6][(i1 >>> 24 & 0x3F)]);
        i1 = j ^ ai1[(j1 + 4)];
        k = j ^ ai1[(j1 + 4 + 1)];
        k = _lrotr(k);
        i ^= (des_SPtrans[1][(k & 0x3F)] | des_SPtrans[3][(k >>> 8 & 0x3F)] | des_SPtrans[5][(k >>> 16 & 0x3F)] | des_SPtrans[7][(k >>> 24 & 0x3F)] | des_SPtrans[0][(i1 & 0x3F)] | des_SPtrans[2][(i1 >>> 8 & 0x3F)] | des_SPtrans[4][(i1 >>> 16 & 0x3F)] | des_SPtrans[6][(i1 >>> 24 & 0x3F)]);
      ...
      for (int k1 = 30; k1 > 0; k1 -= 8)
      {
        ...
        int l = j ^ ai1[(k1 + 1)];
        l = _lrotr(l);
        i ^= (des_SPtrans[1][(l & 0x3F)] | des_SPtrans[3][(l >>> 8 & 0x3F)] | des_SPtrans[5][(l >>> 16 & 0x3F)] | des_SPtrans[7][(l >>> 24 & 0x3F)] | des_SPtrans[0][(i1 & 0x3F)] | des_SPtrans[2][(i1 >>> 8 & 0x3F)] | des_SPtrans[4][(i1 >>> 16 & 0x3F)] | des_SPtrans[6][(i1 >>> 24 & 0x3F)]);
        i1 = i ^ ai1[(k1 - 2)];
        l = i ^ ai1[(k1 - 2 + 1)];
        l = _lrotr(l);
        j ^= (des_SPtrans[1][(l & 0x3F)] | des_SPtrans[3][(l >>> 8 & 0x3F)] | des_SPtrans[5][(l >>> 16 & 0x3F)] | des_SPtrans[7][(l >>> 24 & 0x3F)] | des_SPtrans[0][(i1 & 0x3F)] | des_SPtrans[2][(i1 >>> 8 & 0x3F)] | des_SPtrans[4][(i1 >>> 16 & 0x3F)] | des_SPtrans[6][(i1 >>> 24 & 0x3F)]);
        i1 = j ^ ai1[(k1 - 4)];
        l = j ^ ai1[(k1 - 4 + 1)];
        l = _lrotr(l);
        i ^= (des_SPtrans[1][(l & 0x3F)] | des_SPtrans[3][(l >>> 8 & 0x3F)] | des_SPtrans[5][(l >>> 16 & 0x3F)] | des_SPtrans[7][(l >>> 24 & 0x3F)] | des_SPtrans[0][(i1 & 0x3F)] | des_SPtrans[2][(i1 >>> 8 & 0x3F)] | des_SPtrans[4][(i1 >>> 16 & 0x3F)] | des_SPtrans[6][(i1 >>> 24 & 0x3F)]);
  ...
  public final void des_set_key(byte[] abyte0, int[] ai)
    throws SecurityException
  {
    ...
    for (int l1 = 0; l1 < 16; l1++)
    {
      ...
      i &= 0xFFFFFFF;
      j &= 0xFFFFFFF;
      int i1 = des_skb[0][(i & 0x3F)] | des_skb[1][(i >>> 6 & 0x3 | i >>> 7 & 0x3C)] | des_skb[2][(i >>> 13 & 0xF | i >>> 14 & 0x30)] | des_skb[3][(i >>> 20 & 0x1 | i >>> 21 & 0x6 | i >>> 22 & 0x38)];
      int l = des_skb[4][(j & 0x3F)] | des_skb[5][(j >>> 7 & 0x3 | j >>> 8 & 0x3C)] | des_skb[6][(j >>> 15 & 0x3F)] | des_skb[7][(j >>> 21 & 0xF | j >>> 22 & 0x30)];
